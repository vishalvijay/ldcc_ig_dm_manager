...
- **send_instagram_message**: For responding to joining inquiries and questions. Call ONLY ONCE per response — never send multiple messages. You can combine it with other actions (e.g., send_instagram_message AND react_to_instagram_message).
